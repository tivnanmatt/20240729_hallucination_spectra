...
# Generate samples
# max num_images is 1024
# change to 512x512
# reshape from 512x512 to 64x64?
num_pixel = 64
num_images = 16
num_measurements = 16
num_reconstructions = 1
true_images_pre = torch.zeros(num_images, 1, 1, 1, num_pixel, num_pixel)
...
mean_arr = torch.zeros(num_images)
std_arr = torch.zeros(num_images)
...
for i in range(num_images):
    ...
    for j in range(num_measurements):
        ...
        measurement_var = torch.var(measurement)
