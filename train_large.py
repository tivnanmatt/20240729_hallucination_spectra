...
diffusion_bridge_model = get_diffusion_bridge_model(measurement_noise_variance=measurement_noise_variance, train=True, num_files=2)
...
for iRepeat in range(nRepeats):
    training_loss = diffusion_bridge_model.train_diffusion_backbone(batch_size=12, 
                                                    num_epochs=20, 
